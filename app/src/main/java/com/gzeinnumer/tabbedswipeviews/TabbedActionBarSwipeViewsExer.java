...
public class TabbedActionBarSwipeViewsExer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exer_tabbed_actionbar_swipe_views);
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    ...
                    return page1;
                case 1:
                    ExerExerEditTextFragment page2 = new ExerExerEditTextFragment();
                    return page2;
                case 2:
